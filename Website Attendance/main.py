        ...
        while True:
            ...
            if self.detect_frame:
                ...
                for i in self.face_enc:
                    ...
                    if match[best_match]:
                        nam_loc = self.fam_face_nam[best_match]
                        nam_loc = os.path.splitext(nam_loc)[0]
                        
                        if nam_loc not in self.face_nam:
                            marked(nam_loc)
                            self.face_nam.append(f'{nam_loc}')
